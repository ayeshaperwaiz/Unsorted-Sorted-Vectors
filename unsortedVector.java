...
{ 
    //stores number of assignments and comparisons     static long assignments = 0;     static long comparisons = 0; 
    ...
    { 
        ...
        //reads words to file 
        readWords = readFileToVector(fileName);         Scanner sc = new Scanner(System.in);         sc.close(); 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                uniqueCount.add(stringCount(readWords.get(i), readWords));                 assignments++; //increment the number of assignments made 
            } 
            //comparisons made of all words against each other             comparisons += uniqueWords.size(); 
         } 
    ...
    { 
        ...
        try{ 
            ...
            { 
                String data = sc.nextLine().toLowerCase(); //converts all characters to lowercase                 char ch=' ';                 if (!data.equals("")) 
                    ch = data.charAt(0); // get first character of string                 // adds values to words vector if character is alphabetical.                 if (ch >= 'a' && ch <= 'z')                     words.add(data); 
            }             sc.close(); 
        } 
